        ...
        <main class="main-content">
            ...
            <div class="dashboard-grid" id="statsContainer">
                <div class="stat-card">
                    <div class="stat-card-header">
                        <div>
                            <div class="stat-card-value" id="attendanceValue">--</div>
                            <div class="stat-card-label">Overall Attendance</div>
                        </div>
                        <div class="stat-card-icon blue">📅</div>
                    </div>
                    <div class="progress">
                        <div class="progress-bar" id="attendanceBar" style="width: 0%"></div>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    <div class="stat-card-header">
                        <div>
                            <div class="stat-card-value" id="cgpaValue">--</div>
                            <div class="stat-card-label">Current CGPA</div>
                        </div>
                        <div class="stat-card-icon green">🏆</div>
                    </div>
                    <div class="progress">
                        <div class="progress-bar" id="cgpaBar" style="width: 0%; background: linear-gradient(90deg, #10b981, #059669);"></div>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    <div class="stat-card-header">
                        <div>
                            <div class="stat-card-value" id="feesValue">--</div>
                            <div class="stat-card-label">Pending Fees</div>
                        </div>
                        <div class="stat-card-icon orange">💰</div>
                    </div>
                    <span class="badge badge-warning" id="feesBadge" style="display: none;">Payment Due</span>
                </div>
                
                <div class="stat-card">
                    <div class="stat-card-header">
                        <div>
                            <div class="stat-card-value" id="assignmentsValue">--</div>
                            <div class="stat-card-label">Pending Assignments</div>
                        </div>
                        <div class="stat-card-icon red">📝</div>
                    </div>
                    <span class="badge badge-danger" id="assignmentsBadge" style="display: none;">Urgent</span>
                </div>
            </div>
                        ...
                        <tbody id="activityTableBody">
                            <tr>
                                <td colspan="4" style="text-align: center; padding: 40px; color: var(--text-secondary);">
                                    ...
                                    <small>Your academic activities will appear here</small>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="dashboard-grid">
                <div class="content-card">
                    ...
                    <div id="todayClassesContainer" style="padding: 10px 0; text-align: center; color: var(--text-secondary);">
                        <div style="font-size: 3rem; margin: 20px 0;">📚</div>
                        <p>No classes scheduled for today</p>
                        <small>Check your timetable for full schedule</small>
                    </div>
                </div>
                ...
                <div class="content-card">
                    ...
                    <div id="noticesContainer" style="padding: 10px 0; text-align: center; color: var(--text-secondary);">
                        <div style="font-size: 3rem; margin: 20px 0;">📢</div>
                        <p>No notices available</p>
                        <small>Important announcements will appear here</small>
                    </div>
                </div>
            </div>
        </main>
