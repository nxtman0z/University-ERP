...
<body>
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div class="dashboard-grid">
                <div class="stat-card">
                    <div class="stat-card-header">
                        <div>
                            <div class="stat-card-value" id="averagePercentage">--%</div>
                            <div class="stat-card-label">Average Percentage</div>
                        </div>
                ...
                <div class="stat-card">
                    <div class="stat-card-header">
                        <div>
                            <div class="stat-card-value" id="totalSubjects" style="color: var(--success-color);">--</div>
                ...
                <div class="stat-card">
                    <div class="stat-card-header">
                        <div>
                            <div class="stat-card-value" id="subjectsCleared" style="color: var(--success-color);">--</div>
                            <div class="stat-card-label">Subjects Cleared</div>
                        </div>
                        <div class="stat-card-icon green">✅</div>
                    </div>
                    <span class="badge" id="performanceBadge" style="display: none;"></span>
                </div>
                <div class="stat-card">
                    <div class="stat-card-header">
                        <div>
                            <div class="stat-card-value" id="overallPerformance">--</div>
                            <div class="stat-card-label">Overall Performance</div>
                        </div>
            ...
            <!-- Performance Alert -->
            <div id="performanceAlertsContainer"></div>
            
            <!-- Current Semester Internal Marks -->
            <div class="content-card">
                <div class="card-header">
                    <h3>📋 Semester 5 - Internal Assessment Marks</h3>
                    <button class="btn btn-sm btn-primary" onclick="exportTableToCSV('internalMarks', 'internal-marks')">
                        📥 Export
                    </button>
                </div>
                <div class="table-container">
                    <table id="internalMarks">
                        <thead>
                            <tr>
                                <th>Subject</th>
                                <th>Test 1 (10)</th>
                        ...
                        <tbody id="internalMarksTableBody">
                            <tr>
                                <td colspan="9" style="text-align: center; padding: 40px; color: var(--text-secondary);">
                                    ...
                                    <div>No internal marks available</div>
                                    <small>Your internal assessment marks will appear here</small>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <!-- Semester-wise Performance History -->
            <div class="content-card">
                <div class="card-header">
                    <h3>📜 Semester-wise Internal Marks History</h3>
                </div>
                <div class="table-container">
                    <table>
                        <thead>
                        ...
                        <tbody id="semesterHistoryTableBody">
                            <tr>
                                <td colspan="7" style="text-align: center; padding: 40px; color: var(--text-secondary);">
                                    <div style="font-size: 3rem; margin-bottom: 10px;">📜</div>
                                    <div>No semester history available</div>
                                    <small>Your semester-wise performance will appear here</small>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="content-card">
                ...
                <div style="padding: 40px; text-align: center; color: var(--text-secondary);">
                    ...
                    <small>Subject-wise performance analysis will appear here</small>
                </div>
            </div>
        </main>
    </div>
    ...
    <div id="marksModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3>📊 Detailed Marks Breakdown</h3>
                <span class="modal-close" onclick="closeModal('marksModal')">&times;</span>
            </div>
            <div style="padding: 20px;">
                <h4 id="subjectName" style="color: var(--primary-color); margin-bottom: 15px;"></h4>
                <div style="display: grid; gap: 10px;">
                    <div style="display: flex; justify-content: space-between; padding: 10px; background: var(--light); border-radius: 8px;">
                        ...
                        <span id="test1Score"></span>
                    </div>
                    <div style="display: flex; justify-content: space-between; padding: 10px; background: var(--light); border-radius: 8px;">
                        <span><strong>Test 2:</strong></span>
                        <span id="test2Score"></span>
                    </div>
                    <div style="display: flex; justify-content: space-between; padding: 10px; background: var(--light); border-radius: 8px;">
                        <span><strong>Test 3:</strong></span>
                        <span id="test3Score"></span>
                    </div>
                    <div style="display: flex; justify-content: space-between; padding: 10px; background: var(--light); border-radius: 8px;">
                        <span><strong>Assignment:</strong></span>
                        <span id="assignmentScore"></span>
                    </div>
                    <div style="display: flex; justify-content: space-between; padding: 15px; background: var(--primary-color); color: white; border-radius: 8px; font-size: 18px;">
                        <span><strong>Total:</strong></span>
                        <span id="totalScore"></span>
                    </div>
                </div>
                <button class="btn btn-primary" onclick="closeModal('marksModal')" style="margin-top: 20px; width: 100%;">Close</button>
            </div>
        </div>
    </div>
...
function viewDetails(subject) {
    ...
    if (data) {
        ...
        document.getElementById('test1Score').textContent = data.test1 + '/10';
        document.getElementById('test2Score').textContent = data.test2 + '/10';
        document.getElementById('test3Score').textContent = data.test3 + '/10';
        document.getElementById('assignmentScore').textContent = data.assignment + '/10';
        document.getElementById('totalScore').textContent = data.total + '/40';
        document.getElementById('marksModal').style.display = 'flex';
    }
}

function viewSemesterDetails(semester) {
    alert('Viewing detailed marks for Semester ' + semester);
}
    </script>
</body>
</html>
