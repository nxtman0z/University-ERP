...
<head>
    ...
    <title>Approvals - Faculty Portal</title>
...
.form-control { width: 100%; padding: 10px 15px; background: rgba(255, 255, 255, 0.08); border: 1px solid rgba(200, 169, 81, 0.3); border-radius: 8px; color: #fff; font-size: 0.95rem; font-family: 'Inter', sans-serif; }
.form-control:focus { outline: none; border-color: rgba(200, 169, 81, 0.7); background: rgba(255, 255, 255, 0.12); }
.form-control option { background: #0B1F3B; color: #fff; }
    </style>
</head>
<body>
        ...
        <main class="main-content">
            ...
            <div class="content-card">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h3 id="approvalHeader" style="color: #C8A951;">Pending Approvals (0)</h3>
                    <select class="form-control" id="filterSelect" style="max-width: 200px;" onchange="filterRequests()">
                        <option value="all">All Requests</option>
                        <option value="leave">Leave Requests</option>
                        <option value="assignment">Assignment Extensions</option>
                        <option value="attendance">Attendance Corrections</option>
                    </select>
                </div>
            </div>
            
            <div id="requestsContainer" style="display: grid; gap: 15px;">
                <div class="content-card" style="text-align: center; padding: 40px;">
                    <div style="font-size: 4rem; margin-bottom: 15px; opacity: 0.5;">✅</div>
                    <h3 style="color: rgba(255,255,255,0.6); margin-bottom: 10px;">No Pending Approvals</h3>
                    <p style="color: rgba(255,255,255,0.4);">All approval requests have been processed.</p>
                </div>
            </div>
        </main>
    </div>
