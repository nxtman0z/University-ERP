...
<body>
        ...
        <main class="main-content">
            ...
            <div class="content-card">
                <div style="display: grid; grid-template-columns: auto 1fr; gap: 30px; align-items: start;">
                    <div style="text-align: center;">
                        <div id="profileAvatar" style="width: 150px; height: 150px; background: linear-gradient(135deg, #C8A951, #dcc574); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 4rem; color: #0B1F3B; margin-bottom: 15px; overflow: hidden; position: relative;">
                        ...
                        <button class="btn btn-primary" style="width: 100%; margin-bottom: 10px;" onclick="document.getElementById('photoInput').click()">Upload Photo</button>
                        <button class="btn btn-secondary" style="width: 100%;" onclick="removePhoto()" id="removePhotoBtn">Remove Photo</button>
                    </div>
                    <div>
                        <h2 style="color: #C8A951; margin-bottom: 20px;">Faculty Name</h2>
                        <div style="display: grid; gap: 15px;">
                            <div style="padding: 15px; background: rgba(255, 255, 255, 0.05); border-radius: 8px; border-left: 3px solid #C8A951;">
                                <strong style="color: rgba(255, 255, 255, 0.6);">Employee ID:</strong>
                                <p style="color: rgba(255, 255, 255, 0.9); margin-top: 5px;">--</p>
                            </div>
                            <div style="padding: 15px; background: rgba(255, 255, 255, 0.05); border-radius: 8px; border-left: 3px solid #C8A951;">
                                <strong style="color: rgba(255, 255, 255, 0.6);">Department:</strong>
                                <p style="color: rgba(255, 255, 255, 0.9); margin-top: 5px;">--</p>
                            </div>
                            <div style="padding: 15px; background: rgba(255, 255, 255, 0.05); border-radius: 8px; border-left: 3px solid #C8A951;">
                                <strong style="color: rgba(255, 255, 255, 0.6);">Designation:</strong>
                                <p style="color: rgba(255, 255, 255, 0.9); margin-top: 5px;">--</p>
                            </div>
                            <div style="padding: 15px; background: rgba(255, 255, 255, 0.05); border-radius: 8px; border-left: 3px solid #C8A951;">
                            ...
                            <div style="padding: 15px; background: rgba(255, 255, 255, 0.05); border-radius: 8px; border-left: 3px solid #C8A951;">
                                <strong style="color: rgba(255, 255, 255, 0.6);">Phone:</strong>
                                <p style="color: rgba(255, 255, 255, 0.9); margin-top: 5px;">--</p>
                            </div>
                            <div style="padding: 15px; background: rgba(255, 255, 255, 0.05); border-radius: 8px; border-left: 3px solid #C8A951;">
                                <strong style="color: rgba(255, 255, 255, 0.6);">Joined Date:</strong>
                                <p style="color: rgba(255, 255, 255, 0.9); margin-top: 5px;">--</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-card">
                ...
                <div style="text-align: center; padding: 40px;">
                    <p style="color: rgba(255,255,255,0.4);">No qualifications data available</p>
                </div>
            </div>
            ...
            <div class="content-card">
                ...
                <div style="text-align: center; padding: 40px;">
                    <p style="color: rgba(255,255,255,0.4);">No subjects data available</p>
                </div>
            </div>
        </main>
    </div>
    ...
    <script>
        ...
        function removePhoto() {
            ...
            // Show the icon and hide the image
